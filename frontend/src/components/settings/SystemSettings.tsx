            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => () => handleToggle('dark_mode')}
                  color="primary"
                />
              }
              label="Dark Mode"
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => () => handleToggle('email_notifications')}
                  color="primary"
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => () => handleToggle('two_factor_auth')}
                  color="primary"
                />
              }
