...
const SalesManagement = () => {
    const { token } = useAuth();
    const [sales, setSales] = useState<Type>([]);
    ...
    const [selectedSale, setSelectedSale] = useState<Type>(null);
    ...
    const [snackbar, setSnackbar] = useState<Type>({
        open: false,
        message: '',
        severity: 'success'
    });
                        ...
                        {sales.map((sale) => (
                            <TableRow key={sale.id}>
                                ...
                                <TableCell>
                                    <IconButton
                                        size="small"
                                        onClick={(e: React.MouseEvent<HTMLButtonElement>) => () => handleOpenDialog(sale)}
                                    >
                                        <EditIcon />
                                    </IconButton>
                                    <IconButton
                                        size="small"
                                        onClick={(e: React.MouseEvent<HTMLButtonElement>) => () => handleDelete(sale.id)}
                                    >
                                        <DeleteIcon />
                                    </IconButton>
                                </TableCell>
                                    ...
                                    <Grid container spacing={2} key={index} sx={{ mb: 2 }}>
                                        <Grid item xs={12} md={4}>
                                            <FormControl fullWidth>
                                                ...
                                                <Select
                                                    ...
                                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => (e) => handleItemChange(index, 'product_id', e.target.value)}
                                                    label="Product"
                                                >
                                        ...
                                        <Grid item xs={12} md={3}>
                                            <TextField
                                                ...
                                                type="number"
                                                value={item.quantity}
                                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => (e) => handleItemChange(index, 'quantity', e.target.value)}
                                                required
                                            />
                                        </Grid>
                                        <Grid item xs={12} md={3}>
                                            <TextField
                                                ...
                                                type="number"
                                                value={item.price}
                                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => (e) => handleItemChange(index, 'price', e.target.value)}
                                                required
                                                InputProps={{
                                        ...
                                        <Grid item xs={12} md={2}>
                                            <Button
                                                ...
                                                variant="outlined"
                                                color="error"
                                                onClick={(e: React.MouseEvent<HTMLButtonElement>) => () => removeItem(index)}
