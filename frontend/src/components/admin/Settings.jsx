                        ...
                        <FormControlLabel
                            control={
                                <Switch
                                    ...
                                    onChange={handleChange('security', 'twoFactor')}
                                    color="primary"
                                />
                            }
                        ...
                        <FormControlLabel
                            control={
                                <Switch
                                    ...
                                    onChange={handleChange('security', 'loginAlerts')}
                                    color="primary"
                                />
                            }
                            label="Login Alerts"
                        ...
                        <FormControlLabel
                            control={
                                <Switch
                                    ...
                                    onChange={handleChange('appearance', 'darkMode')}
                                    color="primary"
                                />
                            }
                            label="Dark Mode"
                        ...
                        <FormControlLabel
                            control={
                                <Switch
                                    ...
                                    onChange={handleChange('appearance', 'compactMode')}
                                    color="primary"
                                />
                            }
                            label="Compact Mode"
