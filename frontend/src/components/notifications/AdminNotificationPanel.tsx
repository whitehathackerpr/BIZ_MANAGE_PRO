...
const AdminNotificationPanel = () => {
    ...
    const [editingNotification, setEditingNotification] = useState<Type>(null);
                            ...
                            {notifications.map((notification) => (
                                <TableRow key={notification.id}>
                                    ...
                                    <TableCell>
                                        <IconButton
                                            color="primary"
                                            onClick={(e: React.MouseEvent<HTMLButtonElement>) => () => handleOpenDialog(notification)}
                                        >
                                            <EditIcon />
                                        </IconButton>
                                        <IconButton
                                            color="error"
                                            onClick={(e: React.MouseEvent<HTMLButtonElement>) => () => handleDelete(notification.id)}
                                        >
                                            <DeleteIcon />
                                        </IconButton>
                                    </TableCell>
