...
const NotificationItem = ({ notification, onDelete, onMarkRead }) => {
  ...
  return (
    ...
    >
      ...
      >
        {!notification.read && (
          <MenuItem onClick={() => onMarkRead(notification.id)}>
            Mark as Read
          </MenuItem>
        )}
        <MenuItem onClick={() => onDelete(notification.id)}>Delete</MenuItem>
      </Menu>
    </ListItem>
  );
};
          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={handleChange('email_low_stock')}
              />
            }
          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={handleChange('email_sales')}
              />
            }
            label="Sales Reports"
          />
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={handleChange('email_attendance')}
              />
            }
          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={handleChange('in_app_low_stock')}
              />
            }
            label="Low Stock Alerts"
          />
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={handleChange('in_app_sales')}
              />
            }
            label="Sales Updates"
          />
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={handleChange('in_app_attendance')}
              />
            }
...
const Notifications = () => {
  ...
  return (
    <Box>
      ...
      >
        <MenuItem onClick={handleFilterClose}>All Notifications</MenuItem>
        <MenuItem onClick={handleFilterClose}>Unread Only</MenuItem>
        <MenuItem onClick={handleFilterClose}>Low Stock Alerts</MenuItem>
        <MenuItem onClick={handleFilterClose}>Sales Updates</MenuItem>
      </Menu>
